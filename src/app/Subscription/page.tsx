...
function SubscriptionPage() {
    ...
    return (
        <Box sx={{ padding: 1 }}>
            <Typography variant="h4" sx={{ display: "flex", mb: "3%", mt: "10%", justifyContent: "center", alignItems: "center" }}>Subscription</Typography>
            <Box sx={{ display: "flex", gap: 2, justifyContent: "center", alignItems: "center" }}>
                <Box sx={{ mb: "5%" }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        sx={{ border: "1px solid black", color: "white", backgroundColor: "#81311A", p: 1, mt: 2, borderRadius: 3, width: "250px" }}><b>Subscribe now</b></Button>
                    </Box>
                </Box>
